...
const FormGroup: React.FC<FormGroupProps> = ({
  ...
  <div className={`flex flex-col space-y-2 ${className}`}>
    <label
      htmlFor={htmlFor}
      className="text-sm font-medium text-gray-700 mechanica-text-technical"
    >
      {label}
    </label>
    {children}
    {description && (
      <p className="text-xs text-gray-500 mt-1 mechanica-text-technical">
        {description}
      </p>
    )}
  </div>
...
const getStyleDetails = (style: string | null | undefined) => {
  // Adjusted type to include undefined
  switch (style) {
    case 'visual':
...
export default function ProfileForm() {
  ...
  } = useApiGet<UserProfile>('/api/profile');
  ...
  const {
    ...
    error: submitError,
  } = useApiPost<UserProfile, ProfileFormData>('/api/profile');
      ...
      >
        <div className="min-h-screen flex items-center justify-center">
          <MechanicaCard variant="mechanical" className="p-8 text-center">
            ...
            />
            <h2 className="text-xl font-bold mechanica-heading-professional">
        ...
        <div className="min-h-screen flex items-center justify-center">
          <MechanicaCard variant="mechanical" className="p-8 text-center">
            <MechanicaGear
              ...
              className="mx-auto mb-4"
            />
            <h2 className="text-xl font-bold text-red-600 mechanica-heading-professional">
              Error Loading Profile
            </h2>
            <p className="text-red-600 mechanica-text-technical">
              {initialLoadError}
            </p>
            <MechanicaButton
              variant="mechanical"
            ...
            <MechanicaCard variant="mechanical" animated className="shadow-xl">
              <div className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                  ...
                  <section className="p-6 border border-gray-200 rounded-lg bg-gray-50/50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                      ...
                      <FormGroup
                        label="Phone"
                        htmlFor="phone"
                        description="Optional: Used for important account alerts."
                      >
                        <MechanicaInput
                          type="tel"
                          id="phone"
                  ...
                  {initialProfileData?.primary_vark_preference &&
                    initialProfileData?.vark_profile_data && (
                      <section className="p-6 border border-gray-200 rounded-lg bg-gray-50/50">
                        <div className="flex items-center space-x-3 mb-6">
                          <MechanicaGear
                            size="medium"
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                            {Object.entries(
                              ...
                              return (
                                ...
                                >
                                  <span className={`text-2xl ${details.color}`}>
                                    {details.icon}
                                  </span>
                                  <p className="font-semibold mechanica-text-technical">
                                    {details.label}
                                  </p>
                                  <p className="text-xl font-bold mechanica-heading-mechanical">
                                    {score}
                                  </p>
                                </MechanicaCard>
                              );
