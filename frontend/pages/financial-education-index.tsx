        ...
        <section className="relative py-20 bg-mechanica-moonlight-blue text-white overflow-hidden">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-4 text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 font-serif">
              Complete Financial <span className="text-yellow-400">Curriculum Index</span>
            </h1>
        ...
        <div className="max-w-5xl mx-auto px-4 -mt-10 relative z-20">
          <MechanicaCard variant="mechanical" className="p-8 md:p-12 shadow-2xl">
            <div className="prose prose-lg max-w-none prose-headings:font-serif prose-headings:text-mechanica-moonlight-blue prose-headings:border-b prose-headings:pb-2 prose-headings:mb-8 prose-p:text-gray-600 prose-li:text-gray-600">
              ...
              <div className="mb-16">
                <h2 className="text-3xl font-bold text-mechanica-moonlight-blue uppercase tracking-widest border-amber-400 border-b-4 inline-block">LEVEL 1: FOUNDATIONAL BASICS</h2>
                <div className="grid md:grid-cols-2 gap-8 mt-8">
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 1: Money Fundamentals</h3>
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 2: Personal Finance Basics</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 3: Banking Fundamentals</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 4: Credit Basics</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 5: Saving Money</h3>
                    <ul className="list-none space-y-2 pl-0">
              ...
              <div className="mb-16">
                <h2 className="text-3xl font-bold text-mechanica-moonlight-blue uppercase tracking-widest border-amber-400 border-b-4 inline-block">LEVEL 2: INTERMEDIATE MANAGEMENT</h2>
                <div className="grid md:grid-cols-2 gap-8 mt-8">
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 6: Advanced Budgeting</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 7: Debt Management</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 8: Credit Mastery</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 9: Insurance Fundamentals</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 10: Introduction to Investing</h3>
                    <ul className="list-none space-y-2 pl-0">
              ...
              <div className="mb-16">
                <h2 className="text-3xl font-bold text-mechanica-moonlight-blue uppercase tracking-widest border-amber-400 border-b-4 inline-block">LEVEL 3: ADVANCED INVESTING & WEALTH BUILDING</h2>
                <div className="grid md:grid-cols-2 gap-8 mt-8">
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 11: Stock Market Deep Dive</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 12: Investment Strategies</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 13: Retirement Planning</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 14: Real Estate Investing</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 15: Tax Optimization</h3>
                    <ul className="list-none space-y-2 pl-0">
              ...
              <div className="mb-16">
                <h2 className="text-3xl font-bold text-mechanica-moonlight-blue uppercase tracking-widest border-amber-400 border-b-4 inline-block">LEVEL 4: EXPERT STRATEGIES</h2>
                <div className="grid md:grid-cols-2 gap-8 mt-8">
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 16: Advanced Vehicles</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 17: Technical & Fundamental Analysis</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 18: Advanced Portfolio Management</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 19: Business & Entrepreneurship</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 20: Estate Planning</h3>
                    <ul className="list-none space-y-2 pl-0">
              ...
              <div className="mb-16">
                <h2 className="text-3xl font-bold text-mechanica-moonlight-blue uppercase tracking-widest border-amber-400 border-b-4 inline-block">LEVEL 5: INSTITUTIONAL MASTERY</h2>
                <div className="grid md:grid-cols-2 gap-8 mt-8">
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 21: Advanced Derivatives</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 22: Quantitative Finance</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 23: Fixed Income Advanced</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 24: International Finance</h3>
                    <ul className="list-none space-y-2 pl-0">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-4">Chapter 25+: Wealth Preservation</h3>
                    <ul className="list-none space-y-2 pl-0">
