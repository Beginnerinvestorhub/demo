              ...
              <div className="p-10">
                ...
                <div className="space-y-10">
                  <div className="p-8 bg-amber-900/5 rounded-2xl border border-amber-600/10 shadow-inner">
                    <h4 className="text-xs font-black uppercase tracking-widest text-amber-800 mb-6">
                    ...
                    <ul className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {[
                        ...
                        <li
                          key={i}
                          className="flex items-center text-sm font-black text-amber-950"
                        >
                  ...
                  {[
                    {
                      ...
                      text: 'Deliver personalized simulations and coaching',
                    },
                    {
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div className="text-md font-black text-amber-800/70 italic">
                          &quot;{item.text}&quot;
                        </div>
                      </div>
                    </div>
                ...
                <div className="p-10 bg-amber-900/5 rounded-3xl border-2 border-dashed border-amber-600/30">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {[
                      ...
                      <span
                        key={tool}
                        className="px-5 py-2.5 bg-white border border-amber-600/20 rounded-xl text-xs font-black font-mono text-amber-900 shadow-sm hover:scale-110 transition-transform"
                      >
                        {tool}
                      </span>
                    ))}
              ...
              <div className="p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {[
                    {
                      title: 'Encryption',
                      desc: 'SSL/TLS protocols for all transmissions',
                    },
                    {
                      title: 'Infrastructure',
                      desc: 'Enterprise-grade cloud with auditing',
                    },
                    {
                      title: 'Access Control',
                      desc: 'Multi-factor authentication enabled',
                    },
                    {
                      title: 'Monitoring',
                      desc: '24/7 intrusion detection telemetry',
                    },
                  ].map((item, i) => (
                    <div
                      key={i}
                      className="p-8 bg-slate-900 rounded-3xl border-4 border-slate-800 relative overflow-hidden group shadow-xl"
                    >
                      <div className="relative z-10">
                        <div className="text-[11px] font-black uppercase tracking-widest text-amber-400 mb-2">
                          {item.title}
                        </div>
                        <div className="text-md font-black text-blue-100">
                          {item.desc}
                        </div>
                      </div>
