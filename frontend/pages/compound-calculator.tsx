                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="flex justify-center items-center space-x-6 mb-8">
                            ...
                            <h1 className="text-4xl md:text-5xl lg:text-5xl font-black font-serif uppercase tracking-tighter mechanica-title-gold-chrome mechanica-float">
                                Compound <span className="text-yellow-400">Interest</span> Engine
                            </h1>
                        ...
                        <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto font-light leading-relaxed">
                            See how small, consistent savings grow into substantial wealth over time.
                        </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    <MechanicaCard variant="default" className="p-6 bg-blue-50/50 border-blue-200">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <h3 className="text-sm font-black uppercase tracking-widest text-mechanica-moonlight-blue">1. Start Amount</h3>
                        </div>
                        <p className="text-xs text-slate-600 leading-relaxed font-medium">
                            Enter your starting savings and the monthly amount you plan to add to your account.
                        </p>
                    </MechanicaCard>
                    ...
                    <MechanicaCard variant="mechanical" className="p-6">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <h3 className="text-sm font-black uppercase tracking-widest text-mechanica-moonlight-blue">2. Time Strategy</h3>
                        </div>
                        <p className="text-xs text-slate-600 leading-relaxed font-medium">
                            See how giving your money more time to grow leads to much larger results over many years.
                        </p>
                    </MechanicaCard>
                    ...
                    <MechanicaCard variant="wood" className="p-6">
                        <div className="flex items-center space-x-3 mb-4">
                            ...
                            <h3 className="text-sm font-black uppercase tracking-widest text-mechanica-moonlight-blue">3. Growth Rate</h3>
                        </div>
                        <p className="text-xs text-slate-600 leading-relaxed font-medium">
                            Set your expected yearly return. Even a small increase in your rate can lead to big differences over time.
                        </p>
                    </MechanicaCard>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <MechanicaCard variant="mechanical" className="lg:col-span-1 p-6">
                        <div className="mb-6 flex items-center justify-between border-b border-gray-100 pb-2">
                            ...
                            <span className="text-[8px] font-bold text-gray-400 uppercase tracking-tighter">Settings</span>
                        </div>
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase text-gray-400 tracking-widest">Monthly Savings</label>
                                <input
                                    type="number"
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase text-gray-400 tracking-widest">Investing Time (Years)</label>
                                <input
                                    type="range"
                                    min="1"
                                    max="50"
                                ...
                                />
                                <div className="text-right font-mono text-sm text-mechanica-moonlight-blue">{years} Years</div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-[10px] font-black uppercase text-gray-400 tracking-widest">Growth Rate (%)</label>
                                <input
                                    type="range"
                                    min="1"
                                    max="15"
                                    ...
                                    className="w-full accent-mechanica-moonlight-blue"
                                />
                                <div className="text-right font-mono text-sm text-mechanica-moonlight-blue">{rate}% Growth</div>
                            </div>
                        </div>
                    </MechanicaCard>
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <MechanicaCard variant="wood" className="p-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                                <div className="space-y-6">
                                    <div>
                                        <h3 className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-500 mb-1">Estimated Future Value</h3>
                                    ...
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-[9px] font-black uppercase tracking-widest text-gray-400">Interest Earned</h4>
                        ...
                        <MechanicaCard variant="mechanical" className="p-6 overflow-hidden relative">
                            ...
                            <div className="space-y-4">
                                <p className="text-sm text-gray-600 leading-relaxed">
                                    Compound growth is a <span className="font-bold text-mechanica-moonlight-blue">Growth Booster</span>. Instead of just adding to your savings, you are building a process where the interest earned today becomes part of your balance that generates even more interest tomorrow.
                                </p>

                                <div className="p-4 bg-blue-50 rounded-xl border border-blue-100">
                                    <h4 className="text-[10px] font-black uppercase tracking-widest text-blue-600 mb-2">How it Works:</h4>
                                    <ul className="text-xs text-blue-800 space-y-2 font-medium">
                                        <li className="flex items-start gap-2">
                                            <span className="text-blue-400 mt-1">●</span>
                                            <span>Interest becomes part of your savings, creating a faster growth pattern.</span>
                                        </li>
                                        <li className="flex items-start gap-2">
                                            <span className="text-blue-400 mt-1">●</span>
                                            <span>The longer you keep your plan running, the faster your money grows.</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            // Note: Results are estimates. Consult a professional for financial advice.
                            </div>
                        </MechanicaCard>
