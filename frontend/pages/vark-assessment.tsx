...
export default function VARKAssessmentPage() {
          ...
          <div className="container mx-auto px-4 relative z-20 -mt-20 pb-20">
            <div className="max-w-2xl mx-auto">
              <MechanicaCard
                variant="mechanical"
                animated
                className="p-10 shadow-2xl bg-white/95 backdrop-blur-md border-t-4 border-t-mechanica-moonlight-blue"
              >
            ...
            <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              {[
                ...
                <div
                  key={idx}
                  className="text-center p-6 rounded-2xl border border-gray-100 bg-white/50 backdrop-blur-sm"
                >
                  <div className="text-3xl mb-4">{info.icon}</div>
                  <h4 className="text-sm font-black text-mechanica-moonlight-blue uppercase tracking-widest mb-3">
                    {info.title}
                  </h4>
  ...
  if (step === 2) {
    ...
    const styleDescriptions = {
      visual:
        'You learn best through visual content like charts, graphs, and videos. Focus on investment platforms with strong visual analytics.',
      aural:
        'You prefer auditory learning through podcasts, discussions, and verbal explanations. Consider investment audio books and webinars.',
      readWrite:
        'You excel with text-based learning through articles, books, and note-taking. Prioritize written investment guides and research.',
      kinesthetic:
        'You learn best through hands-on experience and practice. Use investment simulators and interactive learning tools.',
    };
              ...
              <div className="text-center mb-12">
                <div className="flex justify-center items-center space-x-6 mb-8">
                  ...
                  <h1 className="text-4xl md:text-5xl font-bold font-serif text-gray-900">
                    Your Learning{' '}
                    <span className="text-mechanica-moonlight-blue">Style</span>
                  </h1>
                  <MechanicaGear size="xl" color="brass" speed="reverse" />
                </div>
              </div>
