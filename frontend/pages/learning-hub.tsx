            ...
            <div className="min-h-screen bg-slate-900 text-blue-50 relative overflow-hidden">
                ...
                <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
                    <div className="absolute top-0 left-0 w-full h-full"
                        style={{
                            backgroundImage: 'linear-gradient(rgba(79, 115, 142, 0.1) 1px, transparent 1px), linear-gradient(90deg, rgba(79, 115, 142, 0.1) 1px, transparent 1px)',
                ...
                <div className="container mx-auto px-4 py-12 relative z-10">
                    ...
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-blue-200 max-w-2xl mx-auto font-light leading-relaxed">
                            Unlock the secrets of wealth generation through our progressive knowledge modules.
                        </p>
                    </div>
                        ...
                        {modules.map((module, index) => {
                            ...
                            return (
                                <div key={module.id} className="relative group perspective-1000">
                                    ...
                                    <div className={`absolute -inset-1 rounded-2xl bg-gradient-to-r ${isLocked ? 'from-gray-800 to-gray-900' : 'from-blue-500 via-cyan-400 to-blue-600'} opacity-30 blur-md transition-all duration-500 group-hover:opacity-60`}></div>

                                    <div className={`relative h-full bg-slate-800 rounded-2xl border ${isLocked ? 'border-gray-700' : 'border-blue-500/30'} flex flex-col overflow-hidden transition-transform duration-300 group-hover:-translate-y-2 group-hover:shadow-[0_20px_40px_-15px_rgba(59,130,246,0.3)]`}>
                                        ...
                                        <div className="relative p-8 flex flex-col flex-grow z-10 backdrop-blur-sm bg-slate-900/40">
                                            ...
                                            <div className="flex justify-between items-start mb-6">
                                                <div className={`w-14 h-14 rounded-xl flex items-center justify-center text-2xl shadow-inner-premium border border-white/5 ${isLocked ? 'bg-gray-800 text-gray-500' : 'bg-gradient-to-br from-blue-600 to-blue-800 text-white shadow-blue-500/20'}`}>
                                                    {isLocked ? '🔒' : '📖'}
                                                </div>
                                                <div className={`px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest border ${isLocked ? 'bg-gray-800/50 text-gray-500 border-gray-700' : 'bg-blue-900/30 text-blue-300 border-blue-400/30'}`}>
                                                    Module 0{index + 1}
                                                </div>
                                            </div>

                                            <h3 className={`text-2xl font-bold mb-3 font-serif ${isLocked ? 'text-gray-500' : 'text-white group-hover:text-blue-300 transition-colors'}`}>
                                                {module.title}
                                            </h3>

                                            <p className={`text-sm mb-8 flex-grow leading-relaxed font-light ${isLocked ? 'text-gray-600' : 'text-blue-100/70'}`}>
                                                {module.description}
                                            </p>
                                            ...
                                            <div className="space-y-5 mt-auto">
                                                ...
                                                <div className="flex items-center justify-between pt-4 border-t border-white/5">
                                                    <span className={`text-xs font-mono font-bold flex items-center gap-2 ${isLocked ? 'text-gray-600' : 'text-blue-400'}`}>
                                                ...
                                                <div className="pt-2">
                                                    {isLocked ? (
                                                        <button disabled className="w-full py-3 bg-gray-800 text-gray-500 font-bold uppercase tracking-widest text-xs rounded-xl border border-gray-700 cursor-not-allowed">
                                                            Access Denied
                                                        </button>
                                                    ) : (
                                                        <MechanicaButton
                    ...
                    <div className="mt-24 flex flex-col items-center opacity-30 gap-2">
                        ...
                        <div className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-400">System Archives v2.4</div>
                    </div>
                </div>
            </div>
        </MechanicaLayout>
