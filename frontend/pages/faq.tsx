      ...
      <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 relative z-10 py-12 flex flex-col items-center">
              ...
              >
                <div className="p-8">
                  <div className="flex items-start space-x-4">
                    <div className="mt-1">
                      <MechanicaGear size="sm" color={index % 3 === 0 ? 'steel' : index % 3 === 1 ? 'brass' : 'copper'} speed="medium" />
                    </div>
                    <div>
                      <div className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2">Query {index + 1}</div>
          ...
          <div className="w-full max-w-4xl">
            <MechanicaCard variant="wood" animated className="bg-gradient-to-br from-blue-50 to-white mechanica-hum text-center">
              <div className="p-12">
                <div className="flex justify-center items-center space-x-6 mb-8">
