  ...
  return (
    ...
    >
      <Head>
        ...
        <meta name="description" content="Read our Terms of Service to understand the rules and guidelines for using BeginnerInvestorHub’s educational investment tools and portfolio simulation platform." />
      </Head>
      <div className="min-h-screen bg-white">
        ...
        < section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-mechanica-moonlight-blue via-mechanica-moonlight-blue-light to-mechanica-moonlight-blue-dark text-white overflow-hidden">
          ...
          <div className="absolute top-0 left-1/4 w-px h-48 bg-gradient-to-b from-white/20 to-transparent mechanica-steam" style={{ animationDelay: '1.5s' }
          }></div >
          ...
          <div className="relative z-10 text-center px-4 sm: px-6 lg: px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl md: text-2xl text-blue-100 mb-8 max-w-3xl mx-auto font-light leading-relaxed">
                Platform governance frameworks and operational protocols for precision-guided educational tools.
              </p >
                ...
                <div className="space-y-8">
                  ...
                  <div className="bg-amber-900/5 border-2 border-amber-600/20 p-8 rounded-2xl shadow-inner">
                    <div className="flex items-center space-x-3 mb-3">
                      <span className="text-amber-700 font-black text-[10px] uppercase tracking-widest">⚠️ Critical Note</span >
                    </div >
                    <p className="text-amber-900 text-sm font-black italic leading-relaxed">
                      All simulations are for learning purposes only.This system does not facilitate real market transactions.Always consult with qualified financial professionals before making investment decisions.
                    </p >
                  </div >
                </div >
              </div >
                ...
                <div className="grid grid-cols-1 md: grid-cols-2 gap-6">
                  {
                    [
                      ...
                      <div key={i} className="flex items-center p-6 bg-amber-900/5 rounded-xl border border-amber-600/10 group hover: border-amber-600 transition-all shadow-sm">
                        ...
                        <span className="text-sm font-black text-amber-900 uppercase tracking-tight"> {item}</span >
                      </div >
                    ))}
                </div >
              </div >
                ...
                <div className="bg-orange-950/5 border-2 border-orange-600/20 p-10 rounded-2xl shadow-inner space-y-10">
                  {
                    [
                      {
                        label: "No Financial Advice", text: "Nothing here is professional financial advice.We provide educational simulations only."
                      },
                      { label: "Past Performance", text: "Simulated past performance does not guarantee future success in the actual markets." },
                      { label: "AI Limitations", text: "Behavioral insights are algorithmic and intended for educational self-reflection." }
                    ].map((item, i) => (
              ...
              <div className="p-10">
                ...
                <div className="p-10 bg-amber-900/5 border-2 border-dashed border-amber-600/30 rounded-3xl text-center">
                  <p className="text-amber-950 leading-relaxed font-bold text-xl mb-10 max-w-2xl mx-auto">
                    We take your privacy seriously and handle your data transmissions with pharmaceutical-grade precision.
                  </p >
                  <Link href="/privacy" className="inline-flex items-center px-10 py-5 bg-amber-800 text-white rounded-2xl font-black uppercase tracking-widest text-xs shadow-xl hover:bg-amber-700 hover:scale-105 active:scale-95 transition-all">
                    Access Privacy Protocol < span className="ml-3 text-xl">→</span >
                  </Link >
                </div >
              </div >
            </MechanicaCard >
              ...
              <div className="p-10">
                <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                  <div className="flex items-center space-x-8">
                    ...
                    <div>
                      <div className="text-[11px] font-black text-amber-800/60 uppercase tracking-widest mb-1">Support Transmission</div>
                      <div className="text-lg font-black font-mono text-amber-900">info@beginnerinvestorhub.com</div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-8">
                    <div className="w-20 h-20 bg-amber-700/10 rounded-3xl flex items-center justify-center shadow-inner border border-amber-600/10">
                    ...
                    <div>
                      ...
                      <div className="text-lg font-black font-mono text-amber-900">Raleigh, North Carolina, US</div>
                    </div>
                  </div>
                </div>
              </div>
